...
/***/ (function(module, exports, __webpack_require__) {
	...
	angular.module('wd.analyze.game', ['ngRoute', 'wd.shared', 'wd.process', 'wd.parse']).controller('AnalyzeGameCtrl', __webpack_require__(10))
	// from game.js
	...
	function RulesEngine() {
	    ...
	    function setupEngine(parsedLog, log) {
	        ...
	        var rounds = [],
	            ...
	            names = [],
	            // holds player info and pick order until faction selection
	        ...
	        for (var i = 0; i < parsedLog.length; i++) {
	            ...
	            if (parsedAction.setup.option != undefined) {
	                if (parsedAction.setup.option.toLowerCase() === "mini-expansion-1") {
	                    bonuses.push('bon10');
	                } else if (parsedAction.setup.option.toLowerCase() === "fire-and-ice-factions/variable") {
	                    variableFactionVersion = "v1";
	                } else if (parsedAction.setup.option.toLowerCase() === "fire-and-ice-factions/variable_v2") {
	                    variableFactionVersion = "v2";
	                } else if (parsedAction.setup.option.toLowerCase() === "fire-and-ice-factions/variable_v3") {
	                    variableFactionVersion = "v3";
	                } else if (parsedAction.setup.option.toLowerCase() === "fire-and-ice-factions/variable_v4") {
	                    variableFactionVersion = "v4";
	                } else if (parsedAction.setup.option.toLowerCase() === "fire-and-ice-factions/variable_v5") {
	    ...
	    function makePlayer(player, faction, variableFactionVersion) {
	        ...
	        var version;
	        if (faction.toUpperCase() == "SHAPESHIFTERS" || faction.toUpperCase() == "RIVERWALKERS") {
	    ...
	    function shapeshifters_factionAbility(player, round, parsedAction, action) {
	        ...
	        if (!(parsedAction.action.toUpperCase() == "ACTH1" || parsedAction.action.toUpperCase() == "ACTH2")) {
	            return null;
	        }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	angular.module('wd.parse', []).factory('parser', __webpack_require__(12));
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var angular = __webpack_require__(1);
	var faction = __webpack_require__(14);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	angular.module('d3', []).factory('d3', __webpack_require__(16)).directive('d3Heatmap', __webpack_require__(17)).directive('d3Histogram', __webpack_require__(18)).directive('d3Scoregraph', __webpack_require__(19));
